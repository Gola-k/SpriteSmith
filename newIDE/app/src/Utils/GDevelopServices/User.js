...
export const communityLinksConfig = {
  ...
  githubUsername: {
    ...
    getRewardMessage: (hasBadge: boolean, rewardValueInCredits: string) =>
      !hasBadge
        ? t`[Star the ClickEngine repository](https://github.com/Gola-k/SpriteSmith) and add your GitHub username here to get ${rewardValueInCredits} free credits as a thank you!`
