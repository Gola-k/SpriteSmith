      ...
      {({ i18n }) => (
        <ColumnStackLayout expand noMargin>
            ...
            <ResponsiveLineStackLayout noMargin>
              <Column expand noMargin justifyContent="center">
                <Checkbox
                  label={
                    <Trans>
                      Display SpriteSmith logo at startup (in exported game)
                    </Trans>
                  }
              ...
              <Column expand noMargin justifyContent="center">
                <SelectField
                  fullWidth
                  floatingLabelText={<Trans>SpriteSmith logo style</Trans>}
          ...
          <SubscriptionChecker
            ...
            title={<Trans>Disable SpriteSmith splash at startup</Trans>}
          />
        </ColumnStackLayout>
      )}
    </I18n>
