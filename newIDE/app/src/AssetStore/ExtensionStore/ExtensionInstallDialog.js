        ...
        {extensionShortHeader.tier === 'community' && (
          <AlertMessage kind="warning">
            <Trans>
              ...
              by the SpriteSmith extension team. As such, we can't guarantee it
              meets all the quality standards of official extensions. It could
              also not be compatible with older SpriteSmith versions. In case of
        ...
        {!isCompatible && (
          <AlertMessage kind="error">
            <Trans>
              ...
              SpriteSmith to work. Update SpriteSmith to be able to use this
